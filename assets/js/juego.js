...
const divPuntosJugador = document.querySelector('#puntosJugador');
const divPuntosComputadora = document.querySelector('#puntosComputadora');
const divCartasJugador = document.querySelector('#jugador-cartas');
const divCartasComputadora = document.querySelector('#computadora-cartas');
// Referencias HTML Modal
const btnModalNuevo = document.getElementById('btnNuevoJuegoModal');
const btnCerrarModal = document.getElementById('btnCerrarModal');
const mensajeResultado = document.getElementById('mensajeResultado');
const modal = document.getElementById('resultadoModal');
const puntajeFinalJugador = document.getElementById('puntajeFinalJugador');
const puntajeFinalComputadora = document.getElementById('puntajeFinalComputadora');
...
const pedirCarta = () =>{
    ...
    // Sacar la última carta del deck
